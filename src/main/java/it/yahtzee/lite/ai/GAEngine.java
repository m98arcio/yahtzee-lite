...
/**
 * GA minimale con seed e fitness configurabile.
 * Ogni genoma ha una soglia (1..6): teniamo i dadi >= soglia.
 * Fitness = media punteggio su N partite (gamesPerEval).
 */
public class GAEngine {
    ...
    public Genome run(){
        ...
        for(int g=0; g<generations; g++){
            ...
            pop = next;
            System.out.printf("Gen %d  bestFit=%.2f  bestThreshold=%d%n", g, bestFit, best.threshold);
        }
        return best;
    }
