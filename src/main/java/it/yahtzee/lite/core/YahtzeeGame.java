...
public class YahtzeeGame {
    ...
    /**
     * Gioca l'upper section con log: 6 round, dopo 3 roll la strategia decide i dadi da tenere,
     * poi si sceglie la migliore categoria rimasta (greedy).
     * Ritorna MatchLog (upperTotal SENZA bonus).
     */
